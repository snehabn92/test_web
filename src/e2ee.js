...
export async function encryptStream(encryptionKey, readable, writable) {
...
export async function decryptStream(encryptionKey, readable, writable) {
...
async function encryptFunction(encryptionKey, frame, controller) {
    if (encryptionKey) {
...
async function decryptFunction(encryptionKey, frame, controller) {
    if (encryptionKey) {
